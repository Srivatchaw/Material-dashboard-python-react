...
function EditItem() {
  ...
  const fetchItemDetails = async () => {
    ...
    try {
      ...
      setStartDate(itemData.start_date); // Assuming YYYY-MM-DD from backend
      setExpectedCompletionDate(itemData.expected_completion_date);
      setActualCompletionDate(itemData.actual_completion_date || ""); // Handle null
      setStatus(itemData.status);
      setReasonForDelay(itemData.reason_for_delay || ""); // Handle null
    } catch (error) {
      if (error.response) {
